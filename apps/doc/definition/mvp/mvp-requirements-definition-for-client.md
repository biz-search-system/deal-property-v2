...
- 一般ユーザー（admin/member）: 最初の所属組織をActive Organizationに設定
...
| 11 | B会社 | B会社名 | 最大5文字 |
| 12 | 仲介 | 仲介会社名 | 最大5文字 |
| 13 | 進捗 | 業務ステータス | 最大6文字・クリック編集 |
| 14 | 書類 | 書類ステータス | 全文表示・クリック編集 |
| 15 | 備考 | メモ・注意事項 | クリック編集可 |
| 16 | 操作 | 詳細・編集メニュー | 三点メニュー・固定列 |
...
- Active Organization 方式を採用しているため、ログイン後に組織選択画面は表示されません

...
flowchart LR
    ...
    style R fill:#9f1239,color:#fff,stroke:#f87171,stroke-width:2px
```
...
1. **営業活動**:
   - テレアポによる売却アプローチ
   - 売却価格の交渉・合意（○○円ついたら売るという決断を取る）
   - 営業報告と社内承認

2. **マイソク作成・業者配布**: 物件資料作成と買取業者への一括配布
...
- v1.2 - 2025-01-28 - ビジネスモデル理解セクション追加
  - ビジネスモデルの詳細説明を冒頭に追加
  - 取引構造と関係者の定義を明確化
  - 利益構造と計算式を実例付きで説明（利益 = 出口金額 - A金額 + 仲手等）
  - 業務フローの詳細と売上計上ルールを記載
  - セクション番号を整理し構造を改善

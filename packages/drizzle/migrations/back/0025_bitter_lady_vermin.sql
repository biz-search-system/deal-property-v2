...
ALTER TABLE `settlement_progress` ALTER COLUMN "property_title" TO "property_title" integer NOT NULL DEFAULT false;--> statement-breakpoint
...
ALTER TABLE `settlement_progress` ALTER COLUMN "property_title" TO "property_title" integer NOT NULL;--> statement-breakpoint
ALTER TABLE `settlement_progress` ALTER COLUMN "address_change" TO "address_change" integer NOT NULL DEFAULT false;--> statement-breakpoint
ALTER TABLE `settlement_progress` ALTER COLUMN "address_change" TO "address_change" integer NOT NULL;--> statement-breakpoint
ALTER TABLE `settlement_progress` ALTER COLUMN "name_change" TO "name_change" integer NOT NULL DEFAULT false;--> statement-breakpoint
ALTER TABLE `settlement_progress` ALTER COLUMN "name_change" TO "name_change" integer NOT NULL;
...
--> statement-breakpoint
INSERT INTO `__new_settlement_progress`("id", "property_id", "bc_settlement_status", "bc_settlement_status_at", "bc_settlement_status_by", "ab_settlement_status", "ab_settlement_status_at", "ab_settlement_status_by", "loan_calculation_saved", "loan_calculation_saved_at", "loan_calculation_saved_by", "lawyer_requested", "lawyer_requested_at", "lawyer_requested_by", "documents_shared", "documents_shared_at", "documents_shared_by", "management_cancel_scheduled_month", "management_cancel_scheduled_month_at", "management_cancel_scheduled_month_by", "management_cancel_requested_date", "management_cancel_requested_date_at", "management_cancel_requested_date_by", "management_cancel_completed_date", "management_cancel_completed_date_at", "management_cancel_completed_date_by", "identity_verification", "documents_complete", "documents_complete_at", "documents_complete_by", "mortgage_bank_status", "bank_documents_complete", "bank_documents_complete_at", "bank_documents_complete_by", "loan_saved", "loan_saved_at", "loan_saved_by", "seller_payment_done", "seller_payment_done_at", "seller_payment_done_by", "management_cancel", "guarantee_transfer", "key_status", "account_transfer", "ledger_entry", "ledger_entry_at", "ledger_entry_by", "mortgage_cancellation", "mortgage_cancellation_at", "mortgage_cancellation_by", "property_title", "property_title_at", "property_title_by", "address_change", "address_change_at", "address_change_by", "name_change", "name_change_at", "name_change_by", "identity_verification_method", "identity_verification_method_at", "identity_verification_method_by", "identity_verification_call", "identity_verification_call_at", "identity_verification_call_by", "identity_verification_call_schedule", "identity_verification_call_schedule_at", "identity_verification_call_schedule_by", "identity_verification_status", "identity_verification_status_at", "identity_verification_status_by", "seller_funding_status", "seller_funding_status_at", "seller_funding_status_by", "sublease_succession", "sublease_succession_at", "sublease_succession_by", "rental_contract_and_key", "rental_contract_and_key_at", "rental_contract_and_key_by", "guarantee_company_succession", "guarantee_company_succession_at", "guarantee_company_succession_by", "created_at", "updated_at") SELECT "id", "property_id", "bc_settlement_status", "bc_settlement_status_at", "bc_settlement_status_by", "ab_settlement_status", "ab_settlement_status_at", "ab_settlement_status_by", "loan_calculation_saved", "loan_calculation_saved_at", "loan_calculation_saved_by", "lawyer_requested", "lawyer_requested_at", "lawyer_requested_by", "documents_shared", "documents_shared_at", "documents_shared_by", "management_cancel_scheduled_month", "management_cancel_scheduled_month_at", "management_cancel_scheduled_month_by", "management_cancel_requested_date", "management_cancel_requested_date_at", "management_cancel_requested_date_by", "management_cancel_completed_date", "management_cancel_completed_date_at", "management_cancel_completed_date_by", "identity_verification", "documents_complete", "documents_complete_at", "documents_complete_by", "mortgage_bank_status", "bank_documents_complete", "bank_documents_complete_at", "bank_documents_complete_by", "loan_saved", "loan_saved_at", "loan_saved_by", "seller_payment_done", "seller_payment_done_at", "seller_payment_done_by", "management_cancel", "guarantee_transfer", "key_status", "account_transfer", "ledger_entry", "ledger_entry_at", "ledger_entry_by", "mortgage_cancellation", "mortgage_cancellation_at", "mortgage_cancellation_by", "property_title", "property_title_at", "property_title_by", "address_change", "address_change_at", "address_change_by", "name_change", "name_change_at", "name_change_by", "identity_verification_method", "identity_verification_method_at", "identity_verification_method_by", "identity_verification_call", "identity_verification_call_at", "identity_verification_call_by", "identity_verification_call_schedule", "identity_verification_call_schedule_at", "identity_verification_call_schedule_by", "identity_verification_status", "identity_verification_status_at", "identity_verification_status_by", "seller_funding_status", "seller_funding_status_at", "seller_funding_status_by", "sublease_succession", "sublease_succession_at", "sublease_succession_by", "rental_contract_and_key", "rental_contract_and_key_at", "rental_contract_and_key_by", "guarantee_company_succession", "guarantee_company_succession_at", "guarantee_company_succession_by", "created_at", "updated_at" FROM `settlement_progress`;--> statement-breakpoint

...
ALTER TABLE `settlement_progress` ALTER COLUMN "identity_verification_method" TO "identity_verification_method" text DEFAULT 'not_confirmed';--> statement-breakpoint
